...
Restaurants can be searched by cuisine or type of establishment. The user then selects a restaurant to view its information, which includes ratings, and address.
### Launch Instructions
#### Running Flask App
